                ...
                call!!.enqueue(object : Callback<Feed?> {
                    override fun onResponse(call: Call<Feed?>, response: Response<Feed?>) {
                        ...
                        for (entry in entries!!) {
                            ...
                            entris.add(entry.title!!)
                            authors.add(arrayListOf(entry.author!!.name!!,entry.author!!.uri!!))
                        }
                        myRv.adapter = RecyclerViewAdapter(entris,authors)
